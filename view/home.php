...
<body>
  ...
  <section class="home">
    ...
    <div class="content bg-body-tertiary shadow p-3  rounded">
      <h3 class="text-uppercase fw-bold fs-2 text-white">Welcome to Toraja In Art & Culture Festival!</h3>
      <p class="text-white">We warmly greet you to celebrate the beauty of our culture and traditions.</p>
      <div class="cntn rounded">
        <a href="about.php" class=" text-decoration-none ">About Festival</a>
      </div>
    </div>
  ...
  <!-- <section class="dream-cart">
    <div class="main">
      <h2 class="text-uppercase fw-bold fs-2 text-center m-3">Buy your tickets now!</h2>
    </div>
