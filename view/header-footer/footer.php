<footer class="container-fluid border-top border-3 border-dark  text-center my-3">
   ...
   <!-- <div class="row row-cols-2 d-flex justify-content-center align-items-center">
      ...
      <div class="col my-3">
         ...
         <a href="../../php/login.php" class="text-decoration-none m-2" style="color: #19376d;">Login</a>
         <a href="../../php/register.php" class="text-decoration-none m-2" style="color: #19376d;">Register</a>
   ...
   <p class="border-top border-3 border-dark text-center"> &copy; copyright <?php echo date('Y'); ?> by <span>sunnyiuww</span> </p>
